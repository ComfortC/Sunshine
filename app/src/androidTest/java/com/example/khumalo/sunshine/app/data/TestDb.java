 ...
 */
package com.example.khumalo.sunshine.app.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        long weatherID;
        weatherID = db.insert(WeatherContract.WeatherEntry.TABLE_NAME,null,testWeatherValues);
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Weather query validation failed",cursor,testWeatherValues);
