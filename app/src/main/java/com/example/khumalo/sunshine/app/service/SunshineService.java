...
/**
 * Created by KHUMALO on 7/6/2016.
 */
public class SunshineService extends IntentService {


    private ArrayAdapter<String> mForecastAdapter;
    public static final String LOCATION_QUERY_EXTRA_LATIDUDE = "lat";
    public static final String LOCATION_QUERY_EXTRA_LONGTUDE = "lon";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String Longtude = intent.getStringExtra(LOCATION_QUERY_EXTRA_LONGTUDE);
        String Latitude = intent.getStringExtra(LOCATION_QUERY_EXTRA_LATIDUDE);
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter("lon", longtude)
