...
import com.example.khumalo.sunshine.app.data.WeatherContract.WeatherEntry;
import com.example.khumalo.sunshine.app.data.WeatherProvider;
...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.temp_pref),
                mContext.getString(R.string.TemperatureDefaultValue));

        if (unitType.equals(mContext.getString(R.string.Imperial))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.TemperatureDefaultValue))) {
